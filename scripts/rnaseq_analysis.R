...
########################################################
########################################################
# Section IV : compare embryo stage 44 proximal with distal and BL.UA.day13 proximal and distal 
# trying to check the what deposoits the positional information 
########################################################
########################################################
Compare_stage44.proximal.distal_BL.UA.day13.promximal.distal = FALSE
if(Compare_stage44.proximal.distal_BL.UA.day13.promximal.distal){
...
if(Pool.scRNAseq.pseudobulk){
  ...
  saveRDS(dds, file = paste0(RdataDir, '/pseudoBulk_scRNAcellPooling_FluidigmC1_mUA_regeneration_dev.rds'))
